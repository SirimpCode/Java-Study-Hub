...
//  Gujikja 클래스는 CommonMember 클래스의 자식클래스 가 되어진다.	
	...
	public void setJubun(String jubun) {
		...
		if( MyUtil.validationUserField(JobSeeker.UserFieldEnum.PRIMARY_KEY,jubun) ) {
			this.jubun = jubun;
		}
		else {
	...
	*/
	...
	public boolean allNotNull() {
		return this.getId() != null && this.getPasswd() != null && this.getName() != null && this.jubun != null;
	}
